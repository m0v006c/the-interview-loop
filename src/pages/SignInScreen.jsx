...
export default function SignInScreen() {
  const { signIn, configured } = useAuthStore();
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-5">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold mb-3">
            IL
          </div>
          <div className="text-center leading-tight">
            <div className="text-[10px] uppercase tracking-wider text-gray-400">The</div>
            <div className="text-xl font-semibold tracking-tight">Interview Loop</div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-7">
          <div className="text-center mb-6">
            <h1 className="text-xl font-semibold tracking-tight mb-1.5">Sign in to continue</h1>
            <p className="text-sm text-gray-500 leading-relaxed">
              Practice system design, behavioral, coding, and LLD interviews with AI
              interviewers that push back and score you.
            </p>
          </div>
          ...
          {!configured ? (
            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 text-[13px] text-amber-800 dark:text-amber-300 leading-relaxed">
              ...
              to your .env and restart the dev server to enable Google and GitHub sign-in.
            </div>
          ) : (
        ...
        <div className="text-center mt-6 text-[11px] text-gray-400">
          Built for engineers who ship · practice ruthlessly, interview calmly
        </div>
      </div>
    </div>
  );
